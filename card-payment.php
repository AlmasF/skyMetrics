...
<head>
    <?php
        ...
        if(!isset($_SESSION["user_id"]) || !isset($_GET["plan"]) || strlen($_GET["plan"]) <= 0) {
...
<body>
                ...
                <div class="front">
                    ...
                    <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <g id="Front">
                            ...
                            <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">KAIRAT KAIRATULY</text>
    ...
    <a href='api/user/buy.php?plan=<?=$plan?>'>
